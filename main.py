...
parser.add_argument('--root_log', type=str, default='log_fixFULL')
parser.add_argument('--root_model', type=str, default='checkpoint_fixFULL')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Testing dataset with deterministic preprocessing
